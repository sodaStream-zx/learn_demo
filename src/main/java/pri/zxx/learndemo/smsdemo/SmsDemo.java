package pri.zxx.learndemo.smsdemo;
...
public class SmsDemo {
    ...
    static final String accessKeyId = "LTAIlEion0Q8ZyJ2";
    static final String accessKeySecret = "mt7SKlBPWTZYQaFWgx2Kowx8KL9xje";
    ...
    public static QuerySendDetailsResponse querySendDetails(String bizId) throws ClientException {
        ...
        //必填-号码
        request.setPhoneNumber("15282648585");
        //可选-流水号
    ...
    public static void main(String[] args) throws ClientException, InterruptedException {
        ...
        //发短信
        SendSmsResponse response = sendSms("15282648585", "567888");
